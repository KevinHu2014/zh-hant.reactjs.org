...
當 Webpack 遇到這種語法時，它將自動的啟動 code-splitting 你的應用程式。如果你使用 Create React App，它已經幫你設定好了，你可以立即的[使用它](https://facebook.github.io/create-react-app/docs/code-splitting)。在 [Next.js](https://github.com/zeit/next.js/#dynamic-import) 也內建支援這個功能。

如果你是自行設定 Webpack，你可以需要閱讀 Webpack 的 [code-splitting 指南](https://webpack.js.org/guides/code-splitting/)。你的 Webpack 設定看起來應該[像這樣](https://gist.github.com/gaearon/ca6e803f5c604d37468b0091d9959269)。
...
> 注意：
>
> `React.lazy` 和 Suspense 還無法在 server-side rendering 使用。如果你想要在 server render 應用程式做 code-splitting，我們推薦 [Loadable Components](https://github.com/smooth-code/loadable-components)。它有一個用於 server-side render 的 [bundle splitting 的指南]((https://github.com/smooth-code/loadable-components/blob/master/packages/server/README.md))。
